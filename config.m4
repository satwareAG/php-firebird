...
if test "$PHP_FIREBIRD" != "no"; then
  ...
  PHP_NEW_EXTENSION(firebird, firebird.c fbird_query_exec.c fbird_result.c fbird_metadata.c fbird_service.c fbird_events.c fbird_blobs.c fbird_inspection.c, $ext_shared,, -DZEND_ENABLE_STATIC_TSRMLS_CACHE=1,[cxx])
