...
if test "$PHP_FIREBIRD" != "no"; then
  ...
  PHP_NEW_EXTENSION(firebird, firebird.c ibase_query_exec.c ibase_result.c ibase_metadata.c ibase_service.c ibase_events.c ibase_blobs.c ibase_inspection.c, $ext_shared,, -DZEND_ENABLE_STATIC_TSRMLS_CACHE=1,[cxx])
