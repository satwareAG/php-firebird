<?php
// docs/benchmarks/init_perf_table.php
...
//   php docs/benchmarks/init_perf_table.php
//
// This uses the php-firebird extension and config.php env overrides.
...
@fbird_query($link, 'CREATE TABLE perf_test (id INTEGER PRIMARY KEY, payload VARCHAR(100))');
@fbird_query($link, 'DELETE FROM perf_test');
@fbird_query($link, "INSERT INTO perf_test(id, payload) VALUES (1, 'test row')");
@fbird_commit($link);
