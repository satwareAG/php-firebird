...
- [ ] C1: No unescaped user input in `fbird_create_database()` SQL construction
- [ ] C2: SPB buffer in `Firebird\Service::__construct()` validates input lengths
- [ ] M10: `fbird_create_database()` uses dynamic allocation instead of `char[4096]`
- [ ] H5: CONTRIBUTING.md references correct repo URL and PHP/FB versions
- [ ] M7: `config.m4` rejects PHP < 8.2
- [ ] All existing tests pass (no regression)
- [ ] New tests for C1 and C2 edge cases
