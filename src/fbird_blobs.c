...
PHP_FUNCTION(fbird_blob_info)
{
	...
	fbird_db_link *ib_link;
	fbird_transaction *trans = NULL;
	fbird_blob ib_blob = { 0, {0}, BLOB_INPUT, {0, 0}, NULL };  /* magic=0, Phase 6: explicit fbb_blob init */
...
PHP_FUNCTION(fbird_blob_echo)
{
	...
	fbird_db_link *ib_link;
	fbird_transaction *trans = NULL;
	fbird_blob ib_blob_id = { 0, {0}, BLOB_OUTPUT, {0, 0}, NULL };  /* magic=0, Phase 6: explicit fbb_blob init */
...
PHP_FUNCTION(fbird_blob_import)
{
	...
	int size;
	unsigned b;
	fbird_blob ib_blob = { 0, {0}, 0, {0, 0}, NULL };  /* magic=0, Phase 6: explicit fbb_blob init */
	fbird_db_link *ib_link;
	fbird_transaction *trans = NULL;
	char bl_data[FBIRD_BLOB_SEG];
	php_stream *stream;
