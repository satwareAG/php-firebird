--TEST--
fbird_drop_db(): Make sure passing null to the function throws an error.
--SKIPIF--
<?php
include("skipif.inc");
?>
...
Fatal error: Uncaught TypeError: fbird_drop_db(): Argument #1 ($connection) must be of type resource, null given in %a
