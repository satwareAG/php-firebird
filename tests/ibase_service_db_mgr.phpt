...
$info = ibase_db_info($service, $db_path, FBIRD_STS_HDR_PAGES);
...
$res = ibase_maintain_db($service, $db_path, FBIRD_PRP_SWEEP_INTERVAL, 20000);
var_dump($res);
...
$res = ibase_maintain_db($service, $db_path, FBIRD_RPR_VALIDATE_DB, FBIRD_RPR_FULL);
