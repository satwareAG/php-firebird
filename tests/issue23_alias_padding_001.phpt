...
// PHP 8.5 also has different internal behavior affecting this test
if (PHP_VERSION_ID < 80200 || PHP_VERSION_ID >= 80500) {
    die("skip PHP 8.2-8.4 required for deterministic alias ordering");
}
?>
--FILE--
<?php
